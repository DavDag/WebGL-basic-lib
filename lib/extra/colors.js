...
export class Colors {
   ...
   * Built-ins
   */
  static get Red()    { return new Vec3(1.0, 0.0, 0.0); }
  static get Green()  { return new Vec3(0.0, 1.0, 0.0); }
  static get Blue()   { return new Vec3(0.0, 0.0, 1.0); }
  static get White()  { return new Vec3(1.0, 1.0, 1.0); }
  static get Gray()   { return new Vec3(0.5, 0.5, 0.5); }
  static get Black()  { return new Vec3(0.0, 0.0, 0.0); }
  static get Cyan()   { return new Vec3(0.0, 1.0, 1.0); }
  static get Pink()   { return new Vec3(1.0, 0.0, 1.0); }
  static get Yellow() { return new Vec3(1.0, 1.0, 0.0); }
